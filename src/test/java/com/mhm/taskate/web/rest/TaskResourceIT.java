...
import static com.mhm.taskate.web.rest.TestUtil.sameNumber;
...
class TaskResourceIT {
    ...
    private static final Integer DEFAULT_NUMBER_OF_TASKER_REQUIRED = 1;
    private static final Integer UPDATED_NUMBER_OF_TASKER_REQUIRED = 2;
    ...
    private static final TaskStatus DEFAULT_STATUS = TaskStatus.DONE;
    private static final TaskStatus UPDATED_STATUS = TaskStatus.CANCELLED;
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task()
            ...
            .numberOfTaskerRequired(DEFAULT_NUMBER_OF_TASKER_REQUIRED)
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task()
            ...
            .numberOfTaskerRequired(UPDATED_NUMBER_OF_TASKER_REQUIRED)
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getNumberOfTaskerRequired()).isEqualTo(DEFAULT_NUMBER_OF_TASKER_REQUIRED);
        assertThat(testTask.getBudget()).isEqualByComparingTo(DEFAULT_BUDGET);
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberOfTaskerRequired").value(hasItem(DEFAULT_NUMBER_OF_TASKER_REQUIRED)))
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.numberOfTaskerRequired").value(DEFAULT_NUMBER_OF_TASKER_REQUIRED))
    ...
    void putNewTask() throws Exception {
        ...
        assertThat(testTask.getNumberOfTaskerRequired()).isEqualTo(UPDATED_NUMBER_OF_TASKER_REQUIRED);
        assertThat(testTask.getBudget()).isEqualByComparingTo(UPDATED_BUDGET);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).budget(UPDATED_BUDGET);
