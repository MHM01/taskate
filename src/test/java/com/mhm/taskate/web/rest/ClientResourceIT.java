...
import com.mhm.taskate.repository.ClientRepository;
import com.mhm.taskate.service.dto.ClientDTO;
import com.mhm.taskate.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getSubscribedAt()).isEqualTo(DEFAULT_SUBSCRIBED_AT);
        assertThat(testClient.getLicenseStatus()).isEqualTo(DEFAULT_LICENSE_STATUS);
    }
    ...
    void putNewClient() throws Exception {
        ...
        assertThat(testClient.getSubscribedAt()).isEqualTo(UPDATED_SUBSCRIBED_AT);
        assertThat(testClient.getLicenseStatus()).isEqualTo(UPDATED_LICENSE_STATUS);
    }
