...
describe('Client Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call address query and add missing value', () => {
      ...
      const address: ILocation = { id: 71034 };
      client.address = address;

      const addressCollection: ILocation[] = [{ id: 84145 }];
    ...
    it('Should call Task query and add missing value', () => {
      const client: IClient = { id: 456 };
      const tasks: ITask = { id: 7622 };
      client.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 75368 }];
    ...
    it('Should update editForm', () => {
      const client: IClient = { id: 456 };
      const address: ILocation = { id: 58914 };
      client.address = address;
      const tasks: ITask = { id: 71194 };
      client.tasks = tasks;
